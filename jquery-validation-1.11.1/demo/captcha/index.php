...
<head>
 ...
 <script type="text/javascript" src="../../../../recursos humanos/jquery-validation-1.11.1/jquery.validate.js"></script>
...
<fieldset>
 <div id="captchaimage"><a href="<?php echo $_SERVER['../../../../recursos humanos/jquery-validation-1.11.1/demo/captcha/PHP_SELF']; ?>" id="refreshimg" title="Click to refresh image"><img src="images/image.php?<?php echo time(); ?>" width="132" height="46" alt="Captcha image" /></a></div>
